...
public class GrandpaAndKidConversation5: MonoBehaviour
{
    

    [Header("Dialog lines")]
    [SerializeField] private DialogText _grandpaDialog1_fondo_negro;  
    [SerializeField] private DialogText _kidDialog1_con_abuelo;
