...
public class GrandpaAndKidConversation3: MonoBehaviour
{
    

    [Header("Dialog lines")]
    [SerializeField] private DialogText _grandpaDialog1_sobre_fondo_negro;
    [SerializeField] private DialogText _kidDialog1_vuelta_salon;
